...
const experiences = [
  ...
  },
  {
    ...
    description: "Built and maintained high-performance, production-ready web applications using the MERN stack.",
  },
  {
    role: "Full Stack Developer",
    company: "Upskills",
    duration: "Jul 2025 - Current",
    description: "Built high-performance MERN applications, integrated RESTful APIs, and improved user engagement by 10%.",
  },
];

function ExperienceItem({ exp, idx, start, end, scrollYProgress, layout }) {
  const scale = useTransform(scrollYProgress, [start - 0.05, end], [0, 1]);
  const opacity = useTransform(scrollYProgress, [start - 0.05, end], [0, 1]);
